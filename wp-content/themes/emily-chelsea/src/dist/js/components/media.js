...
(function () {
  function vimeo(elementId, vimeoId) {
    ...
    var promise = new Promise(function (resolve, reject) {
      ...
      var player = new Vimeo.Player(elementId, _objectSpread(_objectSpread({}, options), {}, {
        id: vimeoId
      }));
      resolve({
        play: function play() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              $playButton.on("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
                var isPaused;
