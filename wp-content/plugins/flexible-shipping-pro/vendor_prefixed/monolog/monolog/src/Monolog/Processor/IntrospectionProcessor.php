 ...
 */
class IntrospectionProcessor implements \FSProVendor\Monolog\Processor\ProcessorInterface
{
    /** @var int */
    private $level;
    /** @var string[] */
     ...
     */
    public function __construct($level = \FSProVendor\Monolog\Logger::DEBUG, array $skipClassesPartials = [], int $skipStackFramesCount = 0)
    {
        $this->level = \FSProVendor\Monolog\Logger::toMonologLevel($level);
