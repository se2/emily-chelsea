 ...
 */
abstract class AbstractSyslogHandler extends \FSProVendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var int */
    protected $facility;
    /**
     ...
     */
    protected $logLevels = [\FSProVendor\Monolog\Logger::DEBUG => \LOG_DEBUG, \FSProVendor\Monolog\Logger::INFO => \LOG_INFO, \FSProVendor\Monolog\Logger::NOTICE => \LOG_NOTICE, \FSProVendor\Monolog\Logger::WARNING => \LOG_WARNING, \FSProVendor\Monolog\Logger::ERROR => \LOG_ERR, \FSProVendor\Monolog\Logger::CRITICAL => \LOG_CRIT, \FSProVendor\Monolog\Logger::ALERT => \LOG_ALERT, \FSProVendor\Monolog\Logger::EMERGENCY => \LOG_EMERG];
    /**
     ...
     */
    public function __construct($facility = \LOG_USER, $level = \FSProVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    {
        return new \FSProVendor\Monolog\Formatter\LineFormatter('%channel%.%level_name%: %message% %context% %extra%');
    }
}
