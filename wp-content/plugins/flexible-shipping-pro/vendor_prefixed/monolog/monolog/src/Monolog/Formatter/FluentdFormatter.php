 ...
 */
class FluentdFormatter implements \FSProVendor\Monolog\Formatter\FormatterInterface
{
    /**
    ...
    public function format(array $record) : string
    {
        ...
        return \FSProVendor\Monolog\Utils::jsonEncode([$tag, $record['datetime']->getTimestamp(), $message]);
    }
