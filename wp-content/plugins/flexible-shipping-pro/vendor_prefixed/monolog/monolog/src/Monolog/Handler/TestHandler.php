 ...
 */
class TestHandler extends \FSProVendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var Record[] */
    protected $records = [];
    ...
    {
        return isset($this->recordsByLevel[\FSProVendor\Monolog\Logger::toMonologLevel($level)]);
    }
    /**
    ...
    {
        $level = \FSProVendor\Monolog\Logger::toMonologLevel($level);
