 ...
 */
class MercurialProcessor implements \FSProVendor\Monolog\Processor\ProcessorInterface
{
    /** @var Level */
    private $level;
     ...
     */
    public function __construct($level = \FSProVendor\Monolog\Logger::DEBUG)
    {
