 ...
 */
class SocketHandler extends \FSProVendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var string */
     ...
     */
    public function __construct(string $connectionString, $level = \FSProVendor\Monolog\Logger::DEBUG, bool $bubble = \true, bool $persistent = \false, float $timeout = 0.0, float $writingTimeout = 10.0, ?float $connectionTimeout = null, ?int $chunkSize = null)
    {
