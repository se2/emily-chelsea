 ...
 */
class MongoDBFormatter implements \FSProVendor\Monolog\Formatter\FormatterInterface
{
    /** @var bool */
    ...
    protected function formatObject($value, int $nestingLevel)
    {
        ...
        $objectVars['class'] = \FSProVendor\Monolog\Utils::getClass($value);
    ...
    {
        $formattedException = ['class' => \FSProVendor\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
