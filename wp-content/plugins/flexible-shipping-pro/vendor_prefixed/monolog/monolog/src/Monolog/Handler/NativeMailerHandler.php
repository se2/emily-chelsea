 ...
 */
class NativeMailerHandler extends \FSProVendor\Monolog\Handler\MailHandler
{
    /**
     ...
     */
    public function __construct($to, string $subject, string $from, $level = \FSProVendor\Monolog\Logger::ERROR, bool $bubble = \true, int $maxColumnWidth = 70)
    {
    ...
    protected function send(string $content, array $records) : void
    {
        ...
        if ($records) {
            $subjectFormatter = new \FSProVendor\Monolog\Formatter\LineFormatter($this->subject);
