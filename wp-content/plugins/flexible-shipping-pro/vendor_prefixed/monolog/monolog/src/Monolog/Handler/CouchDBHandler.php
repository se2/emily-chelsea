 ...
 */
class CouchDBHandler extends \FSProVendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var mixed[] */
    private $options;
    /**
     * @param mixed[] $options
     */
    public function __construct(array $options = [], $level = \FSProVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
