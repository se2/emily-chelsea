 ...
 */
class MandrillHandler extends \FSProVendor\Monolog\Handler\MailHandler
{
    /** @var Swift_Message */
    protected $message;
    /** @var string */
     ...
     */
    public function __construct(string $apiKey, $message, $level = \FSProVendor\Monolog\Logger::ERROR, bool $bubble = \true)
    {
        parent::__construct($level, $bubble);
        if (!$message instanceof \FSProVendor\Swift_Message && \is_callable($message)) {
            $message = $message();
        }
