 ...
 */
class RotatingFileHandler extends \FSProVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \FSProVendor\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        $this->filename = \FSProVendor\Monolog\Utils::canonicalizePath($filename);
