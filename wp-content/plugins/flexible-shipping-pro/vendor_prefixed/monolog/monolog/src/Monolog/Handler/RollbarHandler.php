...
use FSProVendor\Rollbar\RollbarLogger;
use Throwable;
 ...
 */
class RollbarHandler extends \FSProVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     * @var RollbarLogger
     */
     ...
     */
    public function __construct(\FSProVendor\Rollbar\RollbarLogger $rollbarLogger, $level = \FSProVendor\Monolog\Logger::ERROR, bool $bubble = \true)
    {
