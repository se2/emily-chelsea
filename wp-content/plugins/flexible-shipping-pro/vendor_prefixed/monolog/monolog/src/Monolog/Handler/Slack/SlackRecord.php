 ...
 */
namespace FSProVendor\Monolog\Handler\Slack;
...
class SlackRecord
{
     ...
     */
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = \true, ?string $userIcon = null, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array(), \FSProVendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \FSProVendor\Monolog\Formatter\NormalizerFormatter();
        }
    }
    /**
    ...
    {
        switch (\true) {
            case $level >= \FSProVendor\Monolog\Logger::ERROR:
                return static::COLOR_DANGER;
            case $level >= \FSProVendor\Monolog\Logger::WARNING:
                return static::COLOR_WARNING;
            case $level >= \FSProVendor\Monolog\Logger::INFO:
    ...
    public function stringify(array $fields) : string
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \FSProVendor\Monolog\Utils::jsonEncode($normalized, \JSON_PRETTY_PRINT | \FSProVendor\Monolog\Utils::DEFAULT_JSON_FLAGS) : \FSProVendor\Monolog\Utils::jsonEncode($normalized, \FSProVendor\Monolog\Utils::DEFAULT_JSON_FLAGS);
    }
    /**
    ...
    public function setFormatter(?\FSProVendor\Monolog\Formatter\FormatterInterface $formatter = null) : self
    {
