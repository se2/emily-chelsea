 ...
 */
class RedisPubSubHandler extends \FSProVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($redis, string $key, $level = \FSProVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
