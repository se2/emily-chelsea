...
use FSProVendor\Monolog\Formatter\WildfireFormatter;
 ...
 */
class FirePHPHandler extends \FSProVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \FSProVendor\Monolog\Formatter\WildfireFormatter();
    }
    /**
