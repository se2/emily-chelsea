 ...
 */
class RedisHandler extends \FSProVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($redis, string $key, $level = \FSProVendor\Monolog\Logger::DEBUG, bool $bubble = \true, int $capSize = 0)
    {
        if (!($redis instanceof \FSProVendor\Predis\Client || $redis instanceof \Redis)) {
