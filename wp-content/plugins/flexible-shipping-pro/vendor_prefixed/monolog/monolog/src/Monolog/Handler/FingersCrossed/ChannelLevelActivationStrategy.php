 ...
 */
namespace FSProVendor\Monolog\Handler\FingersCrossed;
 ...
 */
class ChannelLevelActivationStrategy implements \FSProVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface
{
    /**
     * @var Level
     */
    ...
    {
        $this->defaultActionLevel = \FSProVendor\Monolog\Logger::toMonologLevel($defaultActionLevel);
