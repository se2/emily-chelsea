 ...
 */
class PsrHandler extends \FSProVendor\Monolog\Handler\AbstractHandler implements \FSProVendor\Monolog\Handler\FormattableHandlerInterface
{
    /**
     ...
     */
    public function __construct(\Psr\Log\LoggerInterface $logger, $level = \FSProVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
