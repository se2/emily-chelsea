...
class Registry
{
     ...
     * @return void
     */
    public static function addLogger(\FSProVendor\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
    ...
    {
        if ($logger instanceof \FSProVendor\Monolog\Logger) {
     ...
     */
    public static function getInstance($name) : \FSProVendor\Monolog\Logger
    {
