...
(function () {
  function onYouTubeIframeAPIReady(elmentID, youtubeID) {
    var timer = setInterval(function () {
      var _window, _window$YT;
      if ((_window = window) !== null && _window !== void 0 && (_window$YT = _window.YT) !== null && _window$YT !== void 0 && _window$YT.ready) {
  ...
  function loadVideos(items) {
    items.forEach(function (el) {
      ...
      if (!isLoaded) {
        ...
        el === null || el === void 0 ? void 0 : (_el$classList = el.classList) === null || _el$classList === void 0 ? void 0 : _el$classList.add("video-loaded");
      }
    });
  }
